...
# Folder paths
input_folder = '/benchmarking/PRJNA747117/10_yacht'
output_folder = '/benchmarking/PRJNA747117/10_yacht'

# Read the yacht_results.csv file
yacht_results = pd.read_csv(os.path.join(input_folder, 'yacht_results.csv'))
...
yacht_merged.to_csv(os.path.join(output_folder, 'yacht_merged.csv'), index=False)
