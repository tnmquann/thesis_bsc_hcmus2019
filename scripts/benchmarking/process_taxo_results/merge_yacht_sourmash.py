...
directory = '/add/path/to/yacht'

# Load the CSV files
sourmash_csv = pd.read_csv(os.path.join(directory, 'sourmash_benchmarking_processed.csv'))
yacht_csv = pd.read_csv(os.path.join(directory, 'yacht_merged.csv'))
